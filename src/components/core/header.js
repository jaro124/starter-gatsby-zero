  ...
  return (
    <header className="bg-white dark:bg-black shadow-lg">
      <div className="flex flex-wrap items-center justify-between max-w-4xl mx-auto p-4 md:p-4">
        <Link className="flex items-center no-underline text-black dark:text-gray-400" to="/">
          <svg 
            width="32" 
            height="36" 
        ...
        <button
          aria-label="Menu"
          className="block md:hidden border border-white items-center px-3 py-2 rounded text-black dark:text-gray-400"
